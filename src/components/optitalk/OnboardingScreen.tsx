...
export function OnboardingScreen() {
  ...
  const handleStart = async () => {
    ...
    if (companionMode === 'teacher') {
      ...
      // نحول الصديق لـ "Teacher" format عشان ChatScreen يشتغل معاه
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="mt-0.5 text-[11px] text-opti-text/60">
                          {selectedTeacher.personalityAr}
                        </div>
                        <div className="mt-1 text-[10px] italic text-opti-text/50">
