...
export default function ContactPanel() {
  ...
  return (
    <Sheet open={contactOpen} onOpenChange={setContactOpen}>
      <SheetContent
        side="bottom"
        className="mx-auto max-h-[80vh] w-full max-w-md rounded-t-3xl border-t-2 border-[#D4A03C]/30 bg-[#0D0B09] p-0"
      >
        ...
        <div className="space-y-3 p-5 pt-2">
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-[#D4A03C]/15 bg-[#1A1612] px-3 py-2.5 text-sm text-[#F5F0E8] placeholder:text-[#8A8078] focus:border-[#D4A03C]/40 focus:outline-none"
            />
          </div>
          <div>
            <label className="mb-1 flex items-center gap-1 text-xs font-medium text-[#C4A882]">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full resize-none rounded-lg border border-[#D4A03C]/15 bg-[#1A1612] px-3 py-2.5 text-sm text-[#F5F0E8] placeholder:text-[#8A8078] focus:border-[#D4A03C]/40 focus:outline-none"
            />
          </div>
          <button
            onClick={submit}
