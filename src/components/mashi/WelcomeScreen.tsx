        ...
        {mode === "welcome" && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative mb-5 w-full overflow-hidden rounded-3xl border border-[#D4A03C]/25 cairo-shadow-lg"
            >
              <img
            ...
            <motion.p
              ...
              className="mt-2 text-[11px] text-[#8A8078]"
            >
              مقدم من <span className="font-bold text-[#D4A03C]">opti-group</span>
            </motion.p>
