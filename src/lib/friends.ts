...
export const FRIENDS: Friend[] = [
  ...
  {
    id: 'friend-yara', name: 'Yara', nameAr: 'يارا', gender: 'female', age: 'young',
    ...
    greeting: "Hi! I'm Yara! I love fashion and style. What's your favorite outfit?",
    greetingAr: 'أهلاً! أنا يارا. بحب الموضة.',
  ...
  {
    id: 'friend-hassan', name: 'Hassan', nameAr: 'حسن', gender: 'male', age: 'young',
    ...
    greeting: "Hey! I'm Hassan. Science geek here! Did you know anything cool about space?",
    greetingAr: 'أهلاً! أنا حسن. بحب العلوم.',
  ...
  {
    id: 'friend-dina', name: 'Dina', nameAr: 'دينا', gender: 'female', age: 'young',
    ...
    greeting: "Hi! I'm Dina. Movie lover here! What's the last movie you watched?",
    greetingAr: 'أهلاً! أنا دينا. بحب الأفلام.',
